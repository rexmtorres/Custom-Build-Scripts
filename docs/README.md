...
| Task                    | Description                                                                                                                                                                                                                                                        |
| ----------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `createPackage`         | This is the main task that executes all the other tasks described below.  It will also call your modules' `assemble` tasks.<br><br>**_Tip:_**<br>You can finalize your `assemble` task with `createPackage` so that you will only need to call `assemble`.  You can do it like so:<br>&nbsp;&nbsp;&nbsp;&nbsp;`afterEvaluate {`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`assemble.finalizedBy createPackage`<br>&nbsp;&nbsp;&nbsp;&nbsp;`}`|
